...
<head>
    ...
    <style>
        ...
        .content-wrapper {
            background: url("./assets/img/lib1.jpg");
            display: flex;
            justify-content: center;
            align-items: center;
            overflow: hidden;
            margin-top:2px;
            min-height: calc(100vh - 70px); /* Assuming navbar height is 70px */
            padding-top: 70px;
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div style="color:red;font-family:italic; font-size:22px;"> User Login Form </div>
