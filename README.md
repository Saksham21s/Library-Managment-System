...
Hi! Welcome to my repository. The Library Management System (LMS) is designed to change the manual work of managing a library into an online and automatic system. It has important features like adding and managing students and books, and it keeps track of their information efficiently.

It also includes security features such as Captcha Verification and Password Encryption. This is a complete LMS with all the necessary functions, including the ability to generate reports and manage fines.

Note: This is an upgraded version of the Library Management System, which you can find here. I have added more advanced features, like report generation.
...
- Open your web browser and paste this link ("http://localhost/foldername-in-htdocs-directory/"). It should open login page.Credential - Saksham4200@gmail.com  pass- 1234
- Use any credentials from database to login. The password for admin accounts is set to **admin123**
